...
func coinBaseTx(amount uint64, arbitrary string) *types.Tx {
	return types.NewTx(types.TxData{
		...
		Outputs: []*types.TxOutput{
			types.NewTxOutput(*consensus.EYAssetID, amount, mustDecodeHex("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
		},
	})
}
...
func init() {
	...
	t := &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817414d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 41250000000, 0, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00148c704747e94387fa0b8712b053ed2132d84820ac")),
				types.NewTxOutput(*consensus.EYAssetID, 41150000000, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
		}),
	}
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[0].getSourceID(1), *consensus.EYAssetID, 41150000000, 1, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00148c704747e94387fa0b8712b053ed2132d84820ac")),
				types.NewTxOutput(*consensus.EYAssetID, 41050000000, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
		}),
	}
	mockTransaction = append(mockTransaction, t)
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[1].getSourceID(1), *consensus.EYAssetID, 41050000000, 1, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00148c704747e94387fa0b8712b053ed2132d84820ac")),
				types.NewTxOutput(*consensus.EYAssetID, 40950000000, []byte("00144431c4278632c6e35dd2870faa1a4b8e0a275cbc")),
			},
		}),
	}
	mockTransaction = append(mockTransaction, t)
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("453936067da4be89a99bbd78aa8c7eb88cbe92ae0941e1013a58b8d6af65d344"), *consensus.EYAssetID, 41250000000, 0, []byte("00140b0c5059514c751a80c4e1c94f8ecfe16d80671b")),
			...
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 41150000000, []byte("0014b103d8f2dc10e7bbbe2557ff8b9876524dec0a7e")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00140b0c5059514c751a80c4e1c94f8ecfe16d80671b")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 41250000000, 0, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
			...
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
				types.NewTxOutput(*consensus.EYAssetID, 41150000000, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 41150000000, 1, []byte("0014b103d8f2dc10e7bbbe2557ff8b9876524dec0a7e")),
			...
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 41050000000, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014b103d8f2dc10e7bbbe2557ff8b9876524dec0a7e")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 41050000000, 2, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
			...
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40950000000, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 40950000000, 3, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40850000000, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
			},
		}),
	}
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 40850000000, 4, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40750000000, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
			},
		}),
	}
	mockTransaction = append(mockTransaction, t)
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 40750000000, 5, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40650000000, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
			},
		}),
	}
	mockTransaction = append(mockTransaction, t)
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, toHash("ca9b179e549406aa583869e124e39817514d4500a8ce5476e95b6018d182b966"), *consensus.EYAssetID, 40650000000, 6, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40550000000, []byte("0014e809cb6f328db1e624821dec508cbe08fe1ed08d")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
			},
		}),
	}
	mockTransaction = append(mockTransaction, t)
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[3].getSourceID(0), *consensus.EYAssetID, 41150000000, 0, []byte("0014b103d8f2dc10e7bbbe2557ff8b9876524dec0a7e")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 41050000000, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014b103d8f2dc10e7bbbe2557ff8b9876524dec0a7e")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[11].getSourceID(0), *consensus.EYAssetID, 41050000000, 0, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40950000000, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("00142b248deeffe82f9cd94fab43849468e0dfe97806")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[12].getSourceID(0), *consensus.EYAssetID, 40950000000, 0, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40850000000, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014492d5b0f09f83bd9bff6a44514dcc9b11c091dce")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[13].getSourceID(0), *consensus.EYAssetID, 40850000000, 0, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40750000000, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014e3bb841fb722d1840a959d86e12a174c54a3a6e8")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[14].getSourceID(0), *consensus.EYAssetID, 40750000000, 0, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40650000000, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("001449601d4cfb6e7a1b990778497b3c364f66bc17d2")),
	...
	t = &tx{
		Tx: types.NewTx(types.TxData{
			Inputs: []*types.TxInput{
				types.NewSpendInput(nil, *mockTransaction[15].getSourceID(0), *consensus.EYAssetID, 40650000000, 0, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
			},
			Outputs: []*types.TxOutput{
				types.NewTxOutput(*consensus.EYAssetID, 40550000000, []byte("0014e809cb6f328db1e624821dec508cbe08fe1ed08d")),
				types.NewTxOutput(*consensus.EYAssetID, 100000000, []byte("0014bd3d70b1bcd62ece61c06a2fe097a4732e5f006b")),
