...
func init() {
	...
	blockMap = map[int][]*attachBlock{
					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 41250000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab")),
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 41250000000, testutil.MustDecodeHexString("00143d05e891b165b165afefa2e861e83a9745f80d8c")),
							},
						}),
					},
				},
		...
		2: {
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 41350000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab")),
							},
						}),
						types.NewTx(types.TxData{
							Version:   1,
							...
							Inputs: []*types.TxInput{
								types.NewSpendInput(
									...
									*consensus.EYAssetID, 10000000000, 0,
									testutil.MustDecodeHexString("0014cade6dd7cbe2ea2b8ab90dfb8756dda4ba1624bc"),
								),
							},
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 9900000000, testutil.MustDecodeHexString("00143d05e891b165b165afefa2e861e83a9745f80d8c")),
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						...
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 9900000000, testutil.MustDecodeHexString("6a")), // retire
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						...
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewTxOutput(*consensus.EYAssetID, 9900000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab")),
			...
			// with non ey transaction but status fail is true
			{
				block: &types.Block{
					BlockHeader: types.BlockHeader{
						Height:            2,
...
func TestProcessBlock(t *testing.T) {
	cases := []*processBlockTestCase{
		...
		{
			desc:     "attach a block with ey transaction normally",
		...
		{
			desc:     "attach a block with non ey transaction",
		...
		{
			desc:     "attach a block with non ey transaction but status fail is true",
		...
		{
			desc:     "rollback a block has spend ey transaction",
		...
		{
			desc:     "rollback a block has spend non ey",
			newBlock: blockMap[3][0].block,
		...
		{
			desc:     "rollback a block has spend non ey but status fail is true",
			newBlock: blockMap[3][0].block,
		...
		{
			desc:     "rollback a block has spend ey tx, and from orphan manage",
			newBlock: blockMap[2][0].block,
		...
		{
			desc:     "rollback a block has non ey tx, and from orphan manage",
			newBlock: blockMap[2][0].block,
	...
	for i, attachBlock := range attachBlocks {
		...
		for i, tx := range block.Transactions {
			...
			for _, input := range tx.Inputs {
				if statusFail && input.AssetID() != *consensus.EYAssetID {
					continue
				}
			...
			for j, output := range tx.Outputs {
				if statusFail && *tx.Outputs[j].AssetId != *consensus.EYAssetID {
					continue
				}
