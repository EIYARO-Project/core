...
func TestValidateUglyTx(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			desc:     "sum of ey output greater than ey input",
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						...
						*consensus.EYAssetID, 10000000000, 0, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 10000000001, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		...
		{
			category: "fee insufficient",
			desc:     "sum of ey output equals to input ey",
			insts:    []*signingInst{singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		...
		{
			category: "fee insufficient",
			desc:     "sum of ey input greater than ey output, but still insufficient",
			insts:    []*signingInst{singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000001, 0, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
		...
		},
		{
			...
			desc:     "only has ey input, no output",
			insts:    []*signingInst{singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000000, 0, testutil.MustDecodeHexString("6a")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 0, 0, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 0, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs:  []*types.TxInput{},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 10, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, math.MaxUint64, 0, nil),
					types.NewSpendInput(nil,
						bc.Hash{V0: 6970879411704044573, V1: 10086395903308657573, V2: 10107608596190358115, V3: 8645856247221333302},
						*consensus.EYAssetID, 10000000000, 1, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
		...
		{
			category: "overflow",
			desc:     "spend non ey input overflow",
		...
		{
			category: "overflow",
			desc:     "issuance non ey input overflow",
			insts:    []*signingInst{singleSignInst, singleSignInst, singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		{
			category: "overflow",
			desc:     "sum of spend and issuance non ey input overflow",
			insts:    []*signingInst{singleSignInst, singleSignInst, singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, math.MaxUint64, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		...
		{
			category: "overflow",
			desc:     "retire ey output overflow",
			insts:    []*signingInst{singleSignInst, singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, math.MaxUint64, testutil.MustDecodeHexString("6a")),
				},
			},
			err:      true,
			gasValid: false,
		...
		{
			category: "overflow",
			desc:     "retire non ey output overflow",
			insts:    []*signingInst{singleSignInst, singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 100000000, 0, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
					types.NewTxOutput(*consensus.EYAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
					types.NewTxOutput(*consensus.EYAssetID, 290000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000000, 0, testutil.MustDecodeHexString("00140876db6ca8f4542a836f0edd42b87d095d081182")), // wrong control program
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000000, 0, testutil.MustDecodeHexString("00200824e931fb806bd77fdcd291aad3bd0a4493443a4120062bd659e64a3e0bac66")), // wrong control program
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
		...
		{
			category: "verify signature fail",
			desc:     "issuance non ey single sign",
			insts:    []*signingInst{singleSignInst, multiSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		{
			category: "verify signature fail",
			desc:     "issuance non ey multi sign",
			insts:    []*signingInst{singleSignInst, multiSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000000, 0, testutil.MustDecodeHexString("001420a1af4fc11399e6cd7253abf1bbd4d0af17daad")),
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.EYAssetID, 10000000000, 0, testutil.MustDecodeHexString("001420a1af4fc11399e6cd7253abf1bbd4d0af17daad")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 19000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
				},
			},
			err:      true,
			gasValid: true,
		...
		{
			category: "double spend",
			desc:     "non ey asset double spend",
			insts:    []*signingInst{singleSignInst, singleSignInst, singleSignInst},
			txData: types.TxData{
				Version: 1,
				Inputs: []*types.TxInput{
