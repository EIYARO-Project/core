...
func TestValidateTx(t *testing.T) {
	cases := []struct {
		...
		{
			desc: "single utxo, single sign, non asset, ey stanard transaction",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 331,
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						*consensus.EYAssetID, 21819700000, 0, mustDecodeString("001411ef7695d46e1f9288d996c3daa6ff4d956ac355")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 11818900000, mustDecodeString("001415c956112c2b46354690e36051803cc9d5a8f26b")),
					types.NewTxOutput(*consensus.EYAssetID, 10000000000, mustDecodeString("00149c9dd93184cc34ac5d47c145c5af3df852235aad")),
				},
			},
			gasValid: true,
			err:      nil,
		...
		{
			desc: "multi utxo, single sign, non asset, ey stanard transaction",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 595,
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						*consensus.EYAssetID, 11818900000, 0, mustDecodeString("0014e6e1f8b11f1cfb7609037003b90f64837afd272c")),
					types.NewSpendInput(
						[][]byte{
						...
						*consensus.EYAssetID, 99439999900, 2, mustDecodeString("001419f79910f29df2ef80ec10d24c78e2009ed19302")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 1818900000, mustDecodeString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166")),
					types.NewTxOutput(*consensus.EYAssetID, 89439999900, mustDecodeString("0014ca1f877c2787f746a4473adac932171dd18d55d7")),
					types.NewTxOutput(*consensus.EYAssetID, 19900000000, mustDecodeString("00145ade29df622cc68d0473aa1a20fb89690451c66e")),
				},
			},
			gasValid: true,
			err:      nil,
		...
		{
			desc: "multi utxo, single sign, non asset, ey stanard transaction, insufficient gas",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 595,
				Inputs: []*types.TxInput{
					...
					types.NewSpendInput(
						...
						*consensus.EYAssetID, 99960000000, 1, mustDecodeString("0014cfbccfac5018ad4b4bfbcb1fab834e3c85037460")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 1818900000, mustDecodeString("00144b5637cc25b188136f440484f210541fa2a7ce64")),
					types.NewTxOutput(*consensus.EYAssetID, 89960000000, mustDecodeString("0014c7271a69dba57331b36221118dfeb1b1793933df")),
					types.NewTxOutput(*consensus.EYAssetID, 20000000000, mustDecodeString("0014447e597c1c326ad1a639f8023d3f87ae22a4e049")),
				},
			},
			gasValid: false,
		...
		{
			desc: "single utxo, multi sign, non asset, ey stanard transaction",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 396,
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						*consensus.EYAssetID, 89220000000, 1, mustDecodeString("0020ff726649e34c921ff61a97090fc62054f339597acfc710197bb0133e18a19c5c")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 79220000000, mustDecodeString("00206205ec178dc1ac6ea05ea01bb0fcda6aa978173026fa75204a101bdad7bd6b48")),
					types.NewTxOutput(*consensus.EYAssetID, 9900000000, mustDecodeString("0014414eb62abda9a9191f9cba5d7e38d92f3e91e268")),
				},
			},
			gasValid: true,
			err:      nil,
		...
		{
			desc: "single utxo, retire, non asset, ey stanard transaction",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 309,
				Inputs: []*types.TxInput{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 11718900000, mustDecodeString("0014085a02ecdf934a56343aa59a3dec9d9feb86ee43")),
					types.NewTxOutput(*consensus.EYAssetID, 90000000, []byte{byte(vm.OP_FAIL)}),
				},
			},
			gasValid: true,
			err:      nil,
		...
		{
			desc: "single utxo, single sign, issuance, spend, retire, ey stanard transaction, gas sufficient",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 601,
				Inputs: []*types.TxInput{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 1818900000, mustDecodeString("00147d6b00edfbbc758a5da6130a5fa1a4cfec8422c3")),
					types.NewTxOutput(*consensus.EYAssetID, 9900000000, []byte{byte(vm.OP_FAIL)}),
		...
		{
			desc: "single utxo, single sign, issuance, spend, retire, ey stanard transaction, gas insufficient",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 601,
				Inputs: []*types.TxInput{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.EYAssetID, 1818900000, mustDecodeString("001482b7991d64d001009b673ffe3ca2b35eab14f142")),
					types.NewTxOutput(*consensus.EYAssetID, 10000000000, []byte{byte(vm.OP_FAIL)}),
					types.NewTxOutput(bc.AssetID{V0: 8879089148261671560, V1: 16875272676673176923, V2: 14627348561007036053, V3: 5774520766896450836}, 10000000000, mustDecodeString("0014447e597c1c326ad1a639f8023d3f87ae22a4e049")),
				},
			},
			gasValid: false,
		...
		{
			desc: "ey stanard transaction check signature is not passed",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 331,
				Inputs: []*types.TxInput{
		...
		{
			desc: "non ey stanard transaction",
			txData: &types.TxData{
				Version:        1,
				SerializedSize: 508,
				Inputs: []*types.TxInput{
					...
					types.NewSpendInput(
						...
						*consensus.EYAssetID, 9800000000, 2, mustDecodeString("0014cb9f2391bafe2bc1159b2c4c8a0f17ba1b4dd94e")),
				},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(
						bc.AssetID{V0: 986236576456443635, V1: 13806502593573493203, V2: 9657495453304566675, V3: 15226142438973879401},
					...
					types.NewTxOutput(*consensus.EYAssetID, 9750000000, mustDecodeString("0014ec75fda5c727cb0d41137ab62afbf9070a405744")),
				},
			},
			gasValid: true,
			err:      nil,
