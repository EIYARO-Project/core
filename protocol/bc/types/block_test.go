				...
				Transactions: []*Tx{
					NewTx(TxData{
						...
						Inputs: []*TxInput{
							...
							NewSpendInput([][]byte{[]byte("arguments3"), []byte("arguments4")}, testutil.MustDecodeHash("fad5195a0c8e3b590b86a3c0a95e7529565888508aecca96e9aeda633002f409"), *consensus.EYAssetID, 254354, 3, []byte("spendProgram")),
						},
						Outputs: []*TxOutput{
					...
					NewTx(TxData{
						...
						Outputs: []*TxOutput{
							NewTxOutput(*consensus.EYAssetID, 254354, []byte("true")),
							NewTxOutput(*consensus.EYAssetID, 254354, []byte("false")),
						},
					}),
				},
			},
...
func TestReadFrom(t *testing.T) {
	eyAssetID := testutil.MustDecodeAsset("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")
				...
				Transactions: []*Tx{
					{
						TxData: TxData{
							...
							Outputs: []*TxOutput{
								NewTxOutput(eyAssetID, 41450000000, testutil.MustDecodeHexString("001437e1aec83a4e6587ca9609e4e5aa728db7007449")),
							},
						},
					},
					{
						TxData: TxData{
							...
							Outputs: []*TxOutput{
								NewTxOutput(eyAssetID, 9600000000, testutil.MustDecodeHexString("00144b61da45324299e40dacc255e2ea07dfce3a56d2")),
